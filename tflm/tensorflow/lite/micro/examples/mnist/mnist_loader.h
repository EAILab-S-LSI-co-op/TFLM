...
#ifndef TENSORFLOW_LITE_MICRO_EXAMPLES_MNIST_LOADER_H_
#define TENSORFLOW_LITE_MICRO_EXAMPLES_MNIST_LOADER_H_
...
public:
    ...
    MNISTData loadData(const std::string& imageFile, const std::string& labelFile) {
        MNISTData data;
...
#endif  // TENSORFLOW_LITE_MICRO_EXAMPLES_MNIST_LOADER_H_